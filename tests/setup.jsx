...
// jsdom has no network and no layout engine, so the live basemap cannot render
// here. The same switch is what to set when presenting somewhere with no
// reliable connection.
process.env.NEXT_PUBLIC_LIVE_MAP = 'false';
