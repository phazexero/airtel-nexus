...
export const POPULATION_TYPES = {
  it: { label: 'IT workforce', colour: '#ff3b3b' },
  students: { label: 'Students', colour: '#ff8a3d' },
  retirees: { label: 'Retirees', colour: '#f5c453' },
  traders: { label: 'Traders and SMB', colour: '#9aa7b8' },
  value: { label: 'Value households', colour: '#6b7280' },
  affluent: { label: 'Affluent families', colour: '#b01c1c' },
};
