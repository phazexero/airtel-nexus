...
export const CUSTOMERS = [
  {
    ...
    arpu: 299,
    holds: ['Mobile'],
    reason: 'Data exhausted before cycle end, third time this quarter',
    channel: 'App chat',
    waiting: '00:42',
    priority: 'high',
    profile: {
    ...
    signals: [
      'Bought 4 data top-ups in the last 60 days, ₹484 above plan value',
      'Opened the Airtel Black page twice in the last week and left at the price screen',
...
// The phone on the left is Ananya Sen (C-88214), so an agent action on the
