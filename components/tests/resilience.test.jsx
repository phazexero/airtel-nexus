...
describe('a cache from an earlier build', () => {
  it('is discarded when the seed data has changed underneath it', async () => {
    ...
    const stale = {
      ...
      customers: [{ id: 'C-88214', name: 'Someone Removed', initials: 'SR', phone: '000', locality: 'a-removed-area', tenure: 1, plan: 'x', planType: 'prepaid', arpu: 1, holds: [], reason: 'x', channel: 'x', waiting: '00:00', priority: 'low', profile: { pastExperience: 'good', pastExperienceNote: '', temperament: 'warm', temperamentNote: '', communication: 'high', communicationNote: '', language: 'English', languageNote: '', bestTime: '' }, signals: [] }],
      localities: [{ id: 'a-removed-area', name: 'x', pin: '1', subscribers: 1, arpu: 1, prepaidShare: 1, fiberPenetration: 1, churnRisk: 'low', savingsIndex: 1, segment: 'x', need: 'x', product: 'black', evidence: [] }],
