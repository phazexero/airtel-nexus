    ...
    <main className="landing">
      <div className="landing-inner">
        ...
        <div className="landing-note">
          <span className="eyebrow">No sign-in</span>
          <p>
            Both apps open straight into the product. The distributor console has an operator
            switcher in its header instead: work as the supervisor to edit the underlying data, or
            switch to the agent account to see the same console read only.
          </p>
        </div>
      </div>
    </main>
